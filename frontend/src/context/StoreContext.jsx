...
return (
        <StoreContext.Provider value={contextValue}> {/* Fournir le contexte aux composants enfants et leur permettre d'y accéder */}
            {props.children} {/* Rendre les enfants du provider c'est à dire les composants qui seront enveloppés par ce provider, il permet de partager le contexte avec eux */}  
